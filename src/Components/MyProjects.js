    ...
    return(
        <div className="projects">
            ...
            <div className="Card">
                ...
                <strong>Tools Used:</strong>React.js, React Redux, Axios, CSS
                 </p>
                 <a href=" https://github.com/MissTee11/Web-Development-Training/tree/main/Online%20Shopping%20Platform/src" className="gitRepo" target="_blank">GitHub</a>
                </div>
            </div>
